    ...
    <div class="container-fluid pt-4 px-4">
        <div class="row">
            <div class="col-md-12 mb-4 text-center">
                ...
                <a href="./newRemorquesspécialisées.php">
        ...
        <?php
            $transportQuery = "SELECT * FROM transport WHERE category = 'Remorques spécialisées'";
                        ...
                        <div class="col-md-3 mb-4 card-wrapper" data-type="<?php echo htmlspecialchars($row['type']); ?>">
                            <div class="card h-100">
                                ...
                                <div class="card-body">
                                    ...
                                    <p>Model: <?php echo htmlspecialchars($row['modele']); ?></p>
                                    ...
                                    <p>État:
                                        <span class="badge <?php echo $row['state'] == 1 ? 'bg-success' : 'bg-danger'; ?>">
                                            <?php echo $row['state'] == 1 ? 'Activée' : 'Désactivée'; ?>
                                        </span>
