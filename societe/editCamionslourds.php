                    ...
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-floating mb-3">
                            <select class="form-select" id="type" name="type" required>
                                ...
                                <option value="Camions semi-remorques" <?php echo $transport['type'] == 'Camions semi-remorques' ? 'selected' : ''; ?>>Camions semi-remorques</option>
                                <option value="Camions à plateau" <?php echo $transport['type'] == 'Camions à plateau' ? 'selected' : ''; ?>>Camions à plateau</option>
                                <option value="Camions à ridelles" <?php echo $transport['type'] == 'Camions à ridelles' ? 'selected' : ''; ?>>Camions à ridelles</option>
                                <option value="Camions frigorifiques" <?php echo $transport['type'] == 'Camions frigorifiques' ? 'selected' : ''; ?>>Camions frigorifiques</option>
                                <option value="Camions à benne basculante" <?php echo $transport['type'] == 'Camions à benne basculante' ? 'selected' : ''; ?>>Camions à benne basculante</option>
                                <option value="Camions tracteurs" <?php echo $transport['type'] == 'Camions tracteurs' ? 'selected' : ''; ?>>Camions tracteurs</option>
                                <option value="Camions à ordures" <?php echo $transport['type'] == 'Camions à ordures' ? 'selected' : ''; ?>>Camions à ordures</option>
                            </select>
                        ...
                        <div class="form-floating mb-3">
                            <select class="form-select" id="modele" name="modele" required>
                                ...
                                <option value="Freightliner Cascadia" <?php echo $transport['modele'] == 'Freightliner Cascadia' ? 'selected' : ''; ?>>Freightliner Cascadia</option>
                                <option value="International Lonestar" <?php echo $transport['modele'] == 'International Lonestar' ? 'selected' : ''; ?>>International Lonestar</option>
                                <option value="Kenworth T680" <?php echo $transport['modele'] == 'Kenworth T680' ? 'selected' : ''; ?>>Kenworth T680</option>
                                <option value="Peterbilt 579" <?php echo $transport['modele'] == 'Peterbilt 579' ? 'selected' : ''; ?>>Peterbilt 579</option>
                                <option value="Volvo VNL" <?php echo $transport['modele'] == 'Volvo VNL' ? 'selected' : ''; ?>>Volvo VNL</option>
                                <option value="Mack Anthem" <?php echo $transport['modele'] == 'Mack Anthem' ? 'selected' : ''; ?>>Mack Anthem</option>
                                <option value="Isuzu NQR" <?php echo $transport['modele'] == 'Isuzu NQR' ? 'selected' : ''; ?>>Isuzu NQR</option>
                                <option value="Hino 258" <?php echo $transport['modele'] == 'Hino 258' ? 'selected' : ''; ?>>Hino 258</option>
                                <option value="UD Trucks Quester" <?php echo $transport['modele'] == 'UD Trucks Quester' ? 'selected' : ''; ?>>UD Trucks Quester</option>
                                <option value="Fuso Super Great" <?php echo $transport['modele'] == 'Fuso Super Great' ? 'selected' : ''; ?>>Fuso Super Great</option>
                            </select>
