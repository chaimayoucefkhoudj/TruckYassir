                    ...
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-floating mb-3">
                            <select class="form-select" id="modele" name="modele" required>
                                ...
                                <option value="Kenworth T900" <?php echo $transport['modele'] == 'Kenworth T900' ? 'selected' : ''; ?>>Kenworth T900</option>
                                <option value="Peterbilt 360" <?php echo $transport['modele'] == 'Peterbilt 360' ? 'selected' : ''; ?>>Peterbilt 360</option>
                                <option value="Caterpillar 797F Haul Truck" <?php echo $transport['modele'] == 'Caterpillar 797F Haul Truck' ? 'selected' : ''; ?>>Caterpillar 797F Haul Truck</option>
                                <option value="Liebherr LTM 1750-2.1 Mobile Crane" <?php echo $transport['modele'] == 'Liebherr LTM 1750-2.1 Mobile Crane' ? 'selected' : ''; ?>>Liebherr LTM 1750-2.1 Mobile Crane</option>
                                <option value="Scheuerle SPM 40T Multi-Axle Transporter" <?php echo $transport['modele'] == 'Scheuerle SPM 40T Multi-Axle Transporter' ? 'selected' : ''; ?>>Scheuerle SPM 40T Multi-Axle Transporter</option>
                                <option value="Oshkosh M1070A1 HET" <?php echo $transport['modele'] == 'Oshkosh M1070A1 HET' ? 'selected' : ''; ?>>Oshkosh M1070A1 HET</option>
                                <option value="Terex AC 650/50 All Terrain Crane" <?php echo $transport['modele'] == 'Terex AC 650/50 All Terrain Crane' ? 'selected' : ''; ?>>Terex AC 650/50 All Terrain Crane</option>
                                <option value="Manitowoc MLC600 Crawler Crane" <?php echo $transport['modele'] == 'Manitowoc MLC600 Crawler Crane' ? 'selected' : ''; ?>>Manitowoc MLC600 Crawler Crane</option>
                            </select>
