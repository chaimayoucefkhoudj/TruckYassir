        ...
        <div class="row vh-100 bg-light rounded align-items-center justify-content-center mx-0">
            <div class="col-md-8 col-lg-10 col-xl-8 text-center">
                <div class="bg-light rounded h-100 p-4" style="height: 600px;">
                    <h6 class="mb-4">Ajouter une Citerne </h6>
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-floating mb-3">
                            <select class="form-select" id="modele" name="modele" required>
                                ...
                                <option value="MAC Trailer Tri-Axle Dry Bulk Trailer">MAC Trailer Tri-Axle Dry Bulk Trailer</option>
                                <option value="Fruehauf Aluminum Fuel Tanker Trailer">Fruehauf Aluminum Fuel Tanker Trailer</option>
                                <option value="Walker Stainless Steel Chemical Tanker Trailer">Walker Stainless Steel Chemical Tanker Trailer</option>
                                <option value="Strick LNG Tanker Trailer">Strick LNG Tanker Trailer</option>
                                <option value="Haulmark Water Tanker Trailer">Haulmark Water Tanker Trailer</option>
                                <option value="Vac-Tec Waste Water Tanker Trailer">Vac-Tec Waste Water Tanker Trailer</option>
                            </select>
